% This is the main file which should be run to produce the outputs. 
%% Initialization 
...
switch section_enable
    case 1
        ...
        % design of the recontruction filters h3 and h4
        Recons_Filter;
        
        % Save the designed reconstruction filters 
        ...
        % Implementation of the block digram provided in the readme file.
        % 'Signal' is a test signal provided as input to the block
        ...
        % Test the correctness of the designed filters
        % by plotting 'Signal' and 'reconstructed_signal' 
        % If designed h3 and h4 correctly, 'Signal' and
